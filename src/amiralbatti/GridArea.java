...
/**
 * GridArea.java: Alan Kontrolu bu sınıfta oluyor
 *
 * Author : Mahmud Kasım
 */
...
class GridArea extends JPanel
{
	...
	public Point getSelected()
	{
		Point temp = selected;
		selected = null;
		mainHandle.selectedShip = 0;		//Gemiye ulaştıgına emin oluyoruz BUraya Dikkat 
		return temp;
	}
	...
	public void paintComponent(Graphics g)
	{
		...
		//g2.setFont(PlayingField.gameFont);		
	...
	private class MouseHandler extends MouseAdapter
	{
		public void mousePressed(MouseEvent e)
		{
			if(e.getModifiers() == e.BUTTON1_MASK)
			{
				...
				mainHandle.addMessage("Sectiniz: " + selected);	// Sil
			}
			if(e.getModifiers() == e.BUTTON3_MASK)
			{
				vertical = !vertical;		//Vertical lokasyon
				repaint();
			}
		}
	}
